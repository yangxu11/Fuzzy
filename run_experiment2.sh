...
#traffics="random stag_0.1_0.2 stag_0.2_0.3 stag_0.3_0.3 stag_0.4_0.3 stag_0.5_0.3 stag_0.6_0.2 stag_0.7_0.2 stag_0.8_0.1"
...
#	sudo python ./BFlows/fattree.py --k $k --duration $duration --dir $dir --cpu $cpu
	...
	# ECMP
	dir=$out_dir/$flowsPerHost/$traffic/ECMP1
	mkdir -p $dir
	mn -c
	echo '**************************************ECMP*********************************\n'
...
#	# ECMP
#	dir=$out_dir/$flowsPerHost/$traffic/ECMP2
#	mkdir -p $dir
#	mn -c
#	echo '**************************************ECMP*********************************\n'
#	sudo python ./ECMP/fattree.py --k $k --duration $duration --dir $dir --cpu $cpu
...
#	sudo python ./PureSDN/fattree.py --k $k --duration $duration --dir $dir --cpu $cpu
	...
	# Hedera
	dir=$out_dir/$flowsPerHost/$traffic/Hedera1
	mkdir -p $dir
	mn -c
	echo '**************************************Hedera*********************************\n'
...
#	# Hedera
#	dir=$out_dir/$flowsPerHost/$traffic/Hedera2
#	mkdir -p $dir
#	mn -c
#	echo '**************************************Hedera*********************************\n'
#	sudo python ./Hedera/fattree.py --k $k --duration $duration --dir $dir --cpu $cpu
	...
	# Fuzzy
	dir=$out_dir/$flowsPerHost/$traffic/Fuzzy1
	mkdir -p $dir
	mn -c
	echo '**************************************Fuzzy*********************************\n'
	sudo python ./Fuzzy/fattree.py --k $k --duration $duration --dir $dir --cpu $cpu

#	# Fuzzy
#	dir=$out_dir/$flowsPerHost/$traffic/Fuzzy2
#	mkdir -p $dir
#	mn -c
#	echo '**************************************Fuzzy*********************************\n'
#	sudo python ./Fuzzy2/fattree.py --k $k --duration $duration --dir $dir --cpu $cpu
