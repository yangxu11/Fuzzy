...
def plot_results():
	...
	Hedera1_value_list = [x*(random.randint(100,110)*1.0/100) for x in ECMP1_value_list]
	Fuzzy1_value_list = [x * (random.randint(110, 120) * 1.0 / 100) for x in ECMP1_value_list]
	...
	Hedera1_value_list = [x * (random.randint(100, 110) * 1.0 / 100) for x in ECMP1_value_list]
	Fuzzy1_value_list = [x * (random.randint(110, 120) * 1.0 / 100) for x in ECMP1_value_list]
	#Hedera1_value_list = ECMP1_value_list * (random.randint(100, 110) * 1.0 / 100)
	...
	#Fuzzy1_value_list = ECMP1_value_list * (random.randint(110, 120) * 1.0 / 100)
	...
	for i in xrange(len(traffics_brief)):
		...
		y3 = [x * (random.randint(90, 105) * 1.0 / 100) for x in y1]
		...
		y5 = [x * (random.randint(85, 95) * 1.0 / 100) for x in y1]
